...
- האם השפה הבאה רגולרית. תנו הסבר קצר.
	- $L=\{0^n1^n \mid 0\leq n \leq 6 \}$.
		- **תשובה:** השפה סופית ולכן רגולרית. (אפשר לבנות ב"ר המורכב מאיחוד $\cup$ של כל המחרוזות שבשפה).
- האם השפה הבאה חסרת הקשר. 
	- $L=\{0^i 1^j 2^i 3^j \mid i,j \geq 0\}$.
		- **תשובה:**
			- נניח בשלילה שהשפה חסרת הקשר. 
...
- הוכיחו בעזרת רדוקציית מיפוי שהשפה המשלימה של השפה הבאה אינה ניתנת לזיהוי ע"י מ"ט.
	- $L=\{ \langle M , D \rangle \mid M \text{ is a TM, } D \text{ is a DFA, and } L(M) = L(D) \}$
		- **תשובה:**
